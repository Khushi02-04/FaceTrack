...
import { getStudentById } from '@/lib/admin-demo-data'
...
export default function EditStudentPage() {
      ...
      if (response.success && response.data) {
        ...
        if (demoStudent) {
          setFormData({
            ...
            mother_name: 'Demo Parent',
            roll_no: demoStudent.rollNumber,
            class_id: String(demoStudent.id),
          })
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (response.success && response.data) {
      ...
      setSuccessMessage('Student draft updated in demo mode.')
    } else {
